...
<code>
 <context-param>
  ...
  <listener>
    <listener-class>io.mypojo.jcl.web.JclContextLoaderListener</listener-class>
  </listener>
</code>
</pre>
...
http://www.xeustechnologies.org/schema/jcl http://www.xeustechnologies.org/schema/jcl/jcl.xsd">
    ...
    <bean id="test1" class="io.mypojo.jcl.test.Test">
...
<code>
  ...
  // A custom class loader that extends io.mypojo.jcl.proxyclassloader.ProxyClassLoader
...
<pre>
<code>
  -Dio.mypojo.jcl.AbstractClassLoader$ParentLoader=false\
